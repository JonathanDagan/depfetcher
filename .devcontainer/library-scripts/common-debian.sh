...
if [ "${PACKAGES_ALREADY_INSTALLED}" != "true" ]; then
    ...
    if [ "${ADD_NON_FREE_PACKAGES}" = "true" ]; then
        ...
        sed -i "s/deb http:\/\/deb\.debian\.org\/debian ${CODENAME} master/deb http:\/\/deb\.debian\.org\/debian ${CODENAME} master contrib non-free/" /etc/apt/sources.list
        sed -i "s/deb-src http:\/\/deb\.debian\.org\/debian ${CODENAME} master/deb http:\/\/deb\.debian\.org\/debian ${CODENAME} master contrib non-free/" /etc/apt/sources.list
        sed -i "s/deb http:\/\/deb\.debian\.org\/debian ${CODENAME}-updates master/deb http:\/\/deb\.debian\.org\/debian ${CODENAME}-updates master contrib non-free/" /etc/apt/sources.list
        sed -i "s/deb-src http:\/\/deb\.debian\.org\/debian ${CODENAME}-updates master/deb http:\/\/deb\.debian\.org\/debian ${CODENAME}-updates master contrib non-free/" /etc/apt/sources.list
        sed -i "s/deb http:\/\/security\.debian\.org\/debian-security ${CODENAME}\/updates master/deb http:\/\/security\.debian\.org\/debian-security ${CODENAME}\/updates master contrib non-free/" /etc/apt/sources.list
        sed -i "s/deb-src http:\/\/security\.debian\.org\/debian-security ${CODENAME}\/updates master/deb http:\/\/security\.debian\.org\/debian-security ${CODENAME}\/updates master contrib non-free/" /etc/apt/sources.list
        sed -i "s/deb http:\/\/deb\.debian\.org\/debian ${CODENAME}-backports master/deb http:\/\/deb\.debian\.org\/debian ${CODENAME}-backports master contrib non-free/" /etc/apt/sources.list 
        sed -i "s/deb-src http:\/\/deb\.debian\.org\/debian ${CODENAME}-backports master/deb http:\/\/deb\.debian\.org\/debian ${CODENAME}-backports master contrib non-free/" /etc/apt/sources.list
        echo "Running apt-get update..."
        apt-get update
